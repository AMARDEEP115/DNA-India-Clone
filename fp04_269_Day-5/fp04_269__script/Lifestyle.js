...
let news = async()=>{
    // let res= await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=health_care&key=AIzaSyCddIezeyd_pe3YJ1BULXeStXuQzsTPXYs&part=snippet&maxResults=40&relevanceLanguage=en-US&regionCode=IN`);
    let res = await fetch(`https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=b84f4370ccae4b37adea6da2f3fbcd07`);
