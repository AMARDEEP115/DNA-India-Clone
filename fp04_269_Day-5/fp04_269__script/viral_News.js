...
let news = async()=>{
    try{
        // let res= await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=Viral_News&key=AIzaSyB7IEbvo3wkrZvMbfjdk2Va_XfhmPuBlJY&part=snippet&maxResults=40&relevanceLanguage=en-US&regionCode=IN`);
        let res = await fetch(`https://newsapi.org/v2/top-headlines?country=IN&apiKey=b84f4370ccae4b37adea6da2f3fbcd07`);
